...
export default function ConfirmPayment({ invoice }: DetailDialogProps) {
      ...
      <DialogContent className="max-w-7xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <Alert variant="destructive">
            <AlertTitle className="text-red-800">Perhatian</AlertTitle>
            <AlertDescription>
              <p>Jika status pembayaran sudah di setujui, maka status pembayaran tidak dapat diubah lagi. Jangan menolak pembayaran jika ada kesalahan pada bukti pembayaran. Hubungi distributor supaya menginput bukti pembayaran.</p>
            </AlertDescription>
          </Alert>
          <Card>
            <CardHeader>
