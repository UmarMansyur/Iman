...
export default function Form({
  ...
  const [factorySelected, setFactorySelected] = useState<any>('all');
  const [isOtherProduct, setIsOtherProduct] = useState(true);
