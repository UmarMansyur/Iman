...
export default function PabrikPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await fetch(`/api/transaction-distributor?${queryParams}&user_id=${user?.id}`);
      ...
      {loading ? (
        ...
        <Card>
          <CardHeader className="border-b p-4 mb-2">
            <h4 className="text-base font-semibold mb-0">Data Order</h4>
            <p className="text-xs text-muted-foreground">
              Data order yang telah dilakukan dapat dilihat detailnya dengan mengklik tombol detail.
            </p>
          </CardHeader>
