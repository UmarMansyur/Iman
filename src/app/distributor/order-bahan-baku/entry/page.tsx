      ...
      <div className="container mx-auto">
        ...
        <form className="space-y-4 mt-5" onSubmit={handleSubmit}>
          <div className="grid gap-2">
            <Label htmlFor="factory">Nama Pabrik:</Label>
            <Input
              type="text"
              id="factory"
              value={factory}
          ...
          <div className="grid grid-cols-5 gap-4 items-end">
            <div className="grid gap-2">
              ...
              <Select value={currentMaterial} onValueChange={setCurrentMaterial}>
                <SelectTrigger className="w-full" onReset={() => setCurrentMaterial('')}>
                  <SelectValue placeholder="Pilih Bahan Baku" defaultValue={currentMaterial}></SelectValue>
                </SelectTrigger>
                <SelectContent>
                  {materials?.map((material) => (
                    <SelectItem key={'material-'+material.id} value={material.id.toString()}>
