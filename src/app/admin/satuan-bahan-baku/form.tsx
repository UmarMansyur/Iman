...
export default function Form({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("material_id", selectedMaterial?.id.toString() || "");
  ...
  useEffect(() => {
    if (materialUnit) {
      setSelectedMaterial(options.materials.find((material: Material) => material.id === materialUnit.material_id));
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Popover open={materialOpen} onOpenChange={setMaterialOpen}>
                <PopoverTrigger asChild className="col-span-3" name="material_id">
                  ...
                  >
                    {selectedMaterial?.name || options.materials.find((material: Material) => material.id === materialUnit?.material_id)?.name || "Pilih Bahan Baku..."}
