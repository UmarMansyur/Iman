...
const statusColors = {
  ...
  Cancel: "bg-red-100 text-red-400 hover:bg-red-100/80 dark:bg-red-400 dark:text-red-300 border-0",
};
...
export const columns = (page: number, limit: number): ColumnDef<any>[] => [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <Badge variant="outline" className={`text-sm px-3 py-1 ${statusColors[status as keyof typeof statusColors]}`}>
